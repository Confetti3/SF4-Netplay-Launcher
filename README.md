...
**Latest release:** [v0.2.2](https://github.com/Confetti3/SF4e/releases/latest) — copy/UI polish, new broker default, in-app updates, clearer relay errors.
...
**Publish a release:** `powershell -ExecutionPolicy Bypass -File scripts/github-release.ps1 -Tag v0.2.2`. See [docs/RELEASE.md](docs/RELEASE.md).
